...
export function Toast({ message, onDismiss }: ToastProps) {
  return (
    <div
      role="alert"
      className="toast-enter fixed inset-x-4 bottom-5 z-50 mx-auto flex max-w-md items-start gap-3 rounded-[8px] bg-rw-ink px-4 py-3 text-sm leading-5 text-white shadow-[0_12px_34px_rgba(20,33,29,0.24)] sm:bottom-8"
    >
